...
describe "As a user" do
  describe "When I visit / and select Turing from the location drop down" do
    it "I should see the closest electric fuel station to me" do
      ...
      expect(page).to have_content('Station Access Time: MO: Not Specified; TU: Not Specified; WE: Not Specified; TH: Not Specified; FR: Not Specified; SA: Not Specified; SU: Not Specified')
